...
const ProductsDetails = ({ product }) => {
    ...
    return (
        <li className=" px-0 py-0 text-center m-0 " key={product.id}>
            ...
            <h2 className="font-futura-medium-bt text-lg font-normal leading-5 text-#29363C pt-1 mb-8 h-[3em]">
                –{nombre}
            </h2>
            <span className="decoration-black font-futura-medium-bt font-bold text-lg  ">
                S/. {precio.toFixed(2)}
            </span>
